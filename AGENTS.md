...
- ROLE GUDANG: navbar tab POS -> Dashboard, Riwayat -> LAPORAN MASUK/KELUAR (MutationReportPage, label M/K Stok), dan LAPORAN DIHAPUS (backend menolak & tidak dipakai) — navbar gudang = Dashboard, M/K Stok, Stok, Lainnya (`isGudang`).
